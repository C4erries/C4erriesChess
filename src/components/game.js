...
const helper = [{
  style: {
    backgroundColor: '',
    backgroundImage: 'https://upload.wikimedia.org/wikipedia/commons/4/45/Chess_plt45.svg',
    ...
    if (squares[i] && squares[i].player === this.state.player) {
      ...
      if (isMovePossible) {
        ...
        if (isCheckMe) {
          ...
          console.log(whiteFallenSoldiers)
  ...
  render() {
    ...
    return (
       <div>
         ...
         {<FallenSoldierBlock blackFallenSoldiers={helper.concat(this.state.whiteFallenSoldiers)}/>}
          <div className="game-board">
            ...
            />
               ...
               {<FallenSoldierBlock blackFallenSoldiers={helper.concat(this.state.blackFallenSoldiers)}/>}</div>
         </div>
       </div>
